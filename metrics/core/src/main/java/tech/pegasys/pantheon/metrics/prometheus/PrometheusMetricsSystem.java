...
public class PrometheusMetricsSystem implements PantheonMetricsSystem {
  ...
  public static PantheonMetricsSystem init(final MetricsConfiguration metricsConfiguration) {
